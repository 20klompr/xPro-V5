...
- Recommended: place 100-120 ohm network termination resistor at the ends of the RS-485 twisted-pair communications line; this will help to eliminate data pulse signal reflections that can corrupt the data on the line<sub>(2)</sub>. _(any 100-120 ohm standard 1/2-1/4 watt carbon film resistor will suffice)_
