...
- ***With the "...NO.bin" - a Normally Open switch is _not_ required for normal operation, assuming the E-Stop/Door normally open condition is met upon system initialization.***
